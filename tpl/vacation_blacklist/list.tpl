[% INCLUDE includes/header.tpl %]
    <div id="main" role="main">
		...
		[% END %]
		<br />
		<a href="[% base_url %]?rm=create_vac_bl#?w=500" rel="modal_new" class="modallight"><img src="[% media_prefix %]/icons/fffsilk/add.png" border="0" /> [% "Add Entry" | l10n %]</a>
    </div>
    <div id="modal_new" class="modal_block">
    	[% INCLUDE vacation_blacklist/create_partial.tpl %]
    </div>
