...
you are reciving this mail because [% from %] tried to send you a mail which you didn't receive due to their mailserver being misconfigured.
In case you expect messages from [% from %] you should contact him by other means and make sure his ISP or employee fixes his mailserver.
