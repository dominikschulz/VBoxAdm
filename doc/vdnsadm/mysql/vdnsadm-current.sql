...
--
-- Host: localhost    Database: vdnsadm
-- ------------------------------------------------------
...
CREATE TABLE `records` (
  ...
  CONSTRAINT `records_ibfk_1` FOREIGN KEY (`domain_id`) REFERENCES `domains` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2012-02-01 20:05:26
